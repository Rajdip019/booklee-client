    ...
    <div className="cursor-pointer">
      <div>
        ...
        <div className="flex  mb-3 w-[266px]">
          <button
            className="w-[235px] rounded-bl-lg bg-skin-lightGreen text-skin-darkGreen py-3 font-bold text-left pl-4"
            onClick={() => {
              onOpen();
            ...
            <div>
              ...
              >
                ...
                <ModalBody className="text-center">
                  {expandZone ? (
                    <>
                      ...
                      <input
                        type="text"
                        className="w-full mr-auto ml-auto focus:border-green-600 focus:ring-1 focus:ring-green-600"
                        placeholder="OTP"
                      />
                    </>
                  ) : (
                ...
                <ModalFooter display="block" className="text-center">
                  {expandZone ? (
                    <>
                      <button className="ml-auto mr-auto bg-skin-lightGreen text-skin-darkGreen rounded-lg p-3 mt-6 font-bold">
                        Verify
                      </button>
                      <a href="">
                        <p className="text-skin-darkRed underline mt-2">
                          Resend OTP
                        </p>
                      </a>
                    </>
                    ...
                    <button
                      className="ml-auto mr-auto bg-skin-lightGreen text-skin-darkGreen rounded-lg p-3 mt-6 font-bold"

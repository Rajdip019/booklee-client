    ...
    return (
        <div>
            ...
            <div className="flex  mb-3 w-[266px]">
                <button disabled className="w-[235px] rounded-bl-lg bg-skin-lightBlue text-skin-darkBlue py-3 font-bold text-left pl-4">Sold</button>
                <div className="rounded-br-lg bg-skin-lightBlue text-skin-darkBlue w-[35px] cursor-pointer">

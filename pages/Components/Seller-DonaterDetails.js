            ...
            <div className="hidden lg:block">
                ...
                <div className=" bg-gray-100 grid grid-cols-5 p-4 w-[calc(100%-300px)] h-[245px] rounded-2xl ">
                    ...
                    <div className="mt-auto mb-auto text-center ">
                        <Avatar name={props.name} src={props.img} size='lg' className="w-28 h-28 mb-5" />
            ...
            <div className="block lg:hidden">
                <div className="bg-white w-11/12 drop-shadow-xl rounded-xl p-4 ml-auto mr-auto">
                    ...
                    <div className="grid grid-cols-2">
                        <Avatar name={props.name} src={props.img} size='lg' className="w-28 h-28 mb-5 m-auto" />
                        <div className="pl-5">
                    ...
                    <div className="grid grid-cols-2">
                        ...
                        <button className="text-lg text-center bg-skin-darkBlue text-skin-lightBlue p-2 px-6 rounded-3xl mt-2 hover:bg-blue-700 font-semibold">Messege</button>
                        </div>
                    </div>
                </div>
            </div>

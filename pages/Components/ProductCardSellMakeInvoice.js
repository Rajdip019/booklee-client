  ...
  return (
    <div className="cursor-pointer">
      ...
      <div className="flex  mb-3 w-[266px]">
        <button
          className="w-[235px] rounded-bl-lg bg-skin-lightBlue py-3 text-skin-darkBlue font-bold text-left pl-4"
          onClick={() => {
            onOpen();
        ...
        <Menu>
          <MenuButton
            className="bg-skin-lightBlue text-skin-darkBlue rounded-br-lg border-none"
            px={4}
            py={2}
            transition="all 0.2s"
            borderRadius="md"

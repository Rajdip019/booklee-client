        ...
        <div className="flex items-center">
          <span className="hidden xl:block">
            <Link href="/ListBookForSelling">
              <Button className="bg-skin-lightBlue hover:bg-skin-hoverBlue text-skin-darkBlue p-2 px-3 rounded-lg ">
                Sell
              </Button>
            </Link>
          </span>
          <span className="hidden xl:block ">
            {/*Donate Button for Laptop*/}
            <div className="mx-4">
              <Menu>
                <MenuButton
                  py={2}
                ...
                >
                  <div className="w-[35px] mx-4">
                    <Button className="bg-skin-lightGreen hover:bg-skin-hoverGreen text-skin-darkGreen p-2 rounded-lg ">
                      Donate
                    </Button>
                  </div>
                </MenuButton>
                <MenuList className=" bg-white rounded-lg p-2 w-44 shadow-xl ">
                    ...
                    <DrawerBody>
                      <>
                        <div className="text-center">
                          ...
                          <button className="w-full bg-skin-lightBlue text-xl rounded-lg font-semibold text-skin-darkBlue mb-2">
                            Profile
                          </button>
                          <button className="w-full bg-skin-lightBlue text-xl rounded-lg font-semibold text-skin-darkBlue mb-2">
                            Favourite

...
const DonationMainCounter = () => {
    return (
        <div className="h-full w-full">
            ...
            <div className="h-48 w-48 rounded-full bg-skin-lightGreen mx-auto my-10 sm:my-20 pt-[75px] shadow-xl scale-125 sm:scale-150">
                <h1 className="text-4xl font-bold text-center">0/100</h1>
            </div>
            <div className="text-center">
            <Link href="/donatengo/donationadressform">
            <button className="my-5 text-skin-darkGreen bg-skin-lightGreen hover:bg-skin-hoverGreen p-[16px] rounded-xl text-center font-bold">Donate</button>
            </Link>
            </div>
